...
- Customer invoices: INV-1001
- K2 statements: STMT-1002
- Family use records: FAM-1003
...
Start with wireframes and workflow validation before choosing the build stack.

Open question:

Should MVP be no-code/hybrid first, or custom web app from the start?
...
Product photos are important and should be central to the UI.
