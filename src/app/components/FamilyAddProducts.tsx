...
export default function FamilyAddProducts() {
  ...
  const { personName = 'Bill Johnson' } = location.state || {};
  ...
  const handleReviewInvoice = () => {
    navigate('/family-review-invoice', { state: { personName, cart } });
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col pb-24">
      ...
      <div className="bg-white border-b border-gray-200 p-4">
        ...
        <div className="text-sm text-gray-600 mb-2">
          Taken by: <span className="font-medium text-gray-900">{personName}</span>
        </div>
        <div>
...
function QuantityModal({
  ...
  const afterUse = product.available - quantity;
      ...
      >
        ...
        <div className="mb-6 p-3 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium text-gray-900">{afterUse}</span>
          </div>
        </div>
